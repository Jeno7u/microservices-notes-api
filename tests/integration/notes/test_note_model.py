...
class TestNotesModel:
    ...
    async def test_notes_id_generation(self, test_note_data1, test_note_data2, notes_session):
        """Test that notes ID is automatically generated as UUID"""
        test_note1 = Note(
            name=test_note_data1["name"], 
            text=test_note_data1["text"],
            user_id="d3c3a3e7-9613-452a-9d9f-31d2cfb0db96" # random uuid
        )
        test_note2 = Note(
            name=test_note_data2["name"], 
            text=test_note_data2["text"],
